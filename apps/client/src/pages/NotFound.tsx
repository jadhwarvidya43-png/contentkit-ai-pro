    ...
    <div className="min-h-flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-6 flex justify-center space-x-3">
          <Link to="/" className="px-4 py-2 bg-indigo-600 text-white font-medium rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Go home
          </Link>
        </div>
      </div>
